...
-- Seed default plans inspired by PW pricing
INSERT INTO subscription_plans (name, slug, description, price, duration_days, features, display_order) VALUES
    ('Free', 'free', 'Access to free lectures and sample content', 0, 3650, '["free_lectures","sample_tests"]'::jsonb, 1),
    ('Monthly Premium', 'monthly', 'Full access for 30 days', 299, 30, '["all_courses","all_tests","ai_doubts","downloads"]'::jsonb, 2),
    ('Yearly Premium', 'yearly', 'Full access for 365 days', 2999, 365, '["all_courses","all_tests","ai_doubts","downloads","offline"]'::jsonb, 3)
